...
- (nonnull instancetype)init:(NSMutableData * _Nonnull)nsdata isAgoSleep:(BOOL)isAgoSleep OBJC_DESIGNATED_INITIALIZER;
...
typedef SWIFT_ENUM(NSInteger, NotificationType, open) {
  ...
  NotificationTypeOthers = 11,
  NotificationTypeGmail = 12,
  NotificationTypeMessenger = 13,
};
...
@property (nonatomic, strong) NSMutableData * _Null_unspecified nsdata;
@property (nonatomic, readonly, copy) NSString * _Nonnull languageCode;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull hearts;
